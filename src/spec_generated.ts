...
export const LookupRequestContextSchema = ContextSchema;
export type LookupRequestContext = Context;
...
export const CheckoutResponseLinkSchema = LinkSchema;
export type CheckoutResponseLink = Link;
export const ConsentLinkSchema = LinkSchema;
export type ConsentLink = Link;
...
export const ConsentClassSchema = z.object({
  granted: z.boolean(),
  segments: z.record(z.string(), SegmentClassSchema).optional(),
  source: SourceSchema,
});
...
export const FluffyUnitPriceSchema = z.object({
  amount: z.number(),
  currency: z.string(),
  measure: FluffyMeasureSchema,
  reference: FluffyReferenceSchema,
});
export type FluffyUnitPrice = z.infer<typeof FluffyUnitPriceSchema>;
